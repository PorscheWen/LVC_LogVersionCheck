...
class TabFlowPack:
    ...
    def Set_TimeStep(self, **dicType):
        Aliases.MDXProject.wndCMX.pageFlowPack.SysListView32.ClickItem("Filling/Packing :  3*")
        ...
        if l != None:
            #tTotal = dicType["FP"][0] 
            ts = dicType["FP"][1]
        Aliases.MDXProject.dlgDataEditor.SysListView32.ClickItem("%s Analysis [0~*" % ("Filling/Packing"), "3")
