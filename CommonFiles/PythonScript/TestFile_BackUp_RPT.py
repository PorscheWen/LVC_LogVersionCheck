...
def BackupTestingResult(backupInfo_Address, ReadVersion_Py, OutputType, backUplabel, xFileNameLabel):
...
if __name__ == '__main__':
    ...
    backupPoint = BackupTestingResult(backupInfo_Address, ReadVersion_Py, OutputType, backUplabel, xFileNameLabel)    
    print(backupPoint)